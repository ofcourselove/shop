...
<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
		<tbody><tr>
			...
			<?php if(is_array($item)): foreach($item as $key=>$i): ?><tr>
			<td bgcolor="#ffffff">
				<a  target="_blank"><?php echo ($i['goods_name']); ?></a>
			</td>
			<td bgcolor="#ffffff">颜色:黑色 <br></td>
						<td align="right" bgcolor="#ffffff">￥<?php echo ($i['shop_price']); ?>元</td>
						<td class="price" align="right" bgcolor="#ffffff">￥3010.00元</td>
			<td align="right" bgcolor="#ffffff"><?php echo ($i['num']); ?></td>
			<td class="price" align="right" bgcolor="#ffffff">￥<?php echo ($i['num']*$i['shop_price']); ?>元</td>
			</tr>
			<tr>
...
<div class="goodsTitle" style="background:#f6f6f6; border:#E3E3E3 solid 1px; border-bottom:none;">费用总计</div>
	...
	<table class="floatTable" align="center" bgcolor="#e3e3e3" border="0" cellpadding="5" cellspacing="1" width="100%">
	    <tbody><tr>
		    ...
		    <tr>
		    <td align="right" bgcolor="#ffffff">
		      商品总价: <font class="f1 f14b">￥<?php echo ($calc); ?>元</font>
		    </td>
		    </tr>
		    <tr>
		    <td align="right" bgcolor="#ffffff"> 应付款金额:
		     <font class="f1 f14b">￥<?php echo ($calc); ?>元</font>
		    </td>
		  </tr>
		</tbody>
	</table>
