...
<div class="clearfix modContent"> 
    <form name="compareForm" action="" method="post">
        ...
        <div class="clearfix grid"> 
          <?php if(is_array($cat)): foreach($cat as $key=>$c): ?><div class="goodsbox1" style="margin: 5px 9px 8px 8px;*margin:5px 6px 10px 14px;">
        
        <div class="imgbox1">

        <a href=""><img src="/shop/Public<?php echo ($c['thumb_img']); ?>" alt="ECSHOP模板中心68ecs..."></a>
        </div>
        <a href="" title="ECSHOP模板中心68ecshop.com测试商品"><?php echo ($c['goods_name']); ?></a><br>
        <font class="market">￥<?php echo ($c['market_price']); ?></font> 
        <b class="f1">￥<?php echo ($c['shop_price']); ?>元</b><br>
