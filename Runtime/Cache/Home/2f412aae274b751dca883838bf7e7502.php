...
<div class="block1">
    <div class="site-bar"><font id="ECS_MEMBERZONE">
      <?php if(check()): ?>您好，<?php echo (cookie('username')); ?> 欢迎光临本店！ 
...
<div class="cagegoryCon clearfix">
  <dl>
  <?php if(is_array($cat)): foreach($cat as $key=>$v): if( $v['parent_id'] == 0 ): ?><dt><a href="<?php echo U('Home/cat/cat',array('cat_id'=>$c['cat_id']));?>"><?php echo ($v["cat_name"]); ?></a></dt>
  <dd class="clearfix"> 
      <?php if(is_array($cat)): foreach($cat as $key=>$c): if($v['cat_id'] == $c['parent_id']): ?><p class=""><a href="<?php echo U('Home/cat/cat',array('cat_id'=>$c['cat_id']));?>" title="CDMA手机" class="txtdot"><?php echo ($c["cat_name"]); ?></a></p><?php endif; endforeach; endif; ?>
...
<tbody><tr><td><a href="" target="_blank"><img src="/shop/Public/Home/images/1370400501175025752.jpg" width="230" height="100" border="0"></a></td></tr>
    ...
    <div class="w230"> 	
<h1 class="mod2tit" style="background:url(themes/68ecshop_hechafree/images/sdgg.gif) repeat-x; height:27px; color:#000">浏览历史</h1>
<div class="mod1 mod2 blank" id="topbox">
	<span class="lb"></span><span class="rb"></span>
	 <ul id="top10">
		 	<li>
        <?php if(is_array($history)): foreach($history as $key=>$h): ?><div class="first">
			  
        <div class="fl">
				<font style="color:#F00; font-weight:bold"><?php echo ($h['goods_id']); ?></font> 
        <a href="<?php echo U('Home/goods/goods',array('goods_id'=>$h['goods_id']));?>" title="">
...
<div class="recommendContent entry-content" id="show_hot_area">
    <?php if(is_array($goods)): foreach($goods as $key=>$g): ?><div class="goodsbox1">
				<div class="imgbox1"><a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$g['goods_id']));?>"><img src="/shop/Public<?php echo ($g["thumb_img"]); ?>" alt="ECSHOP模板中心68ecshop.com测试商品"></a></div>
			 <a href="<?php echo U('Home/Goods/goods',array('goods_id'=>$g['goods_id']));?>" title="ECSHOP模板中心68ecshop.com测试商品"><?php echo ($g["goods_name"]); ?></a><br>
              <font class="goodspice market"><?php echo ($g["market_price"]); ?></font>
			 			 <b class="f1"><?php echo ($g["shop_price"]); ?></b><br>
			</div><?php endforeach; endif; ?>
</div>
</div>
    <div class="blank">
